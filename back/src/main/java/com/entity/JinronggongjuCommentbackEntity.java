...
public class JinronggongjuCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JinronggongjuCommentbackEntity() {

	}

	public JinronggongjuCommentbackEntity(T t) {
		try {
    ...
    public String toString() {
        return "JinronggongjuCommentback{" +
            ", id=" + id +
            ", jinronggongjuId=" + jinronggongjuId +
            ", yonghuId=" + yonghuId +
            ", jinronggongjuCommentbackText=" + jinronggongjuCommentbackText +
