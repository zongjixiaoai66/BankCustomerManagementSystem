...
public class LicaichanpinCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LicaichanpinCommentbackEntity() {

	}

	public LicaichanpinCommentbackEntity(T t) {
		try {
    ...
    public String toString() {
        return "LicaichanpinCommentback{" +
            ", id=" + id +
            ", licaichanpinId=" + licaichanpinId +
            ", yonghuId=" + yonghuId +
            ", licaichanpinCommentbackText=" + licaichanpinCommentbackText +
