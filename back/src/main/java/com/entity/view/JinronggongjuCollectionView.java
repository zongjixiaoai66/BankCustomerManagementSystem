...
public class JinronggongjuCollectionView extends JinronggongjuCollectionEntity implements Serializable {
	...
	*/
	...
	private String jinronggongjuCollectionValue;
	...
	public JinronggongjuCollectionView() {

	}

	public JinronggongjuCollectionView(JinronggongjuCollectionEntity jinronggongjuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jinronggongjuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getJinronggongjuCollectionValue() {
		return jinronggongjuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setJinronggongjuCollectionValue(String jinronggongjuCollectionValue) {
		this.jinronggongjuCollectionValue = jinronggongjuCollectionValue;
	}
	...
	public String toString() {
		return "JinronggongjuCollectionView{" +
			", jinronggongjuCollectionValue=" + jinronggongjuCollectionValue +
