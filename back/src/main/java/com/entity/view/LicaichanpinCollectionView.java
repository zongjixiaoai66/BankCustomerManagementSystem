...
public class LicaichanpinCollectionView extends LicaichanpinCollectionEntity implements Serializable {
	...
	*/
	...
	private String licaichanpinCollectionValue;
	...
	public LicaichanpinCollectionView() {

	}

	public LicaichanpinCollectionView(LicaichanpinCollectionEntity licaichanpinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, licaichanpinCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getLicaichanpinCollectionValue() {
		return licaichanpinCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setLicaichanpinCollectionValue(String licaichanpinCollectionValue) {
		this.licaichanpinCollectionValue = licaichanpinCollectionValue;
	}
	...
	public String toString() {
		return "LicaichanpinCollectionView{" +
			", licaichanpinCollectionValue=" + licaichanpinCollectionValue +
