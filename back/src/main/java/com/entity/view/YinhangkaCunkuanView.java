...
public class YinhangkaCunkuanView extends YinhangkaCunkuanEntity implements Serializable {
	...
	public YinhangkaCunkuanView() {

	}

	public YinhangkaCunkuanView(YinhangkaCunkuanEntity yinhangkaCunkuanEntity) {
		try {
			BeanUtils.copyProperties(this, yinhangkaCunkuanEntity);
