...
public class YinhangkaJiluView extends YinhangkaJiluEntity implements Serializable {
	...
	* 银行卡记录类型的值
	*/
	@ColumnInfo(comment="银行卡记录类型的字典表值",type="varchar(200)")
	private String yinhangkaJiluValue;
	...
	public YinhangkaJiluView() {

	}

	public YinhangkaJiluView(YinhangkaJiluEntity yinhangkaJiluEntity) {
		try {
			BeanUtils.copyProperties(this, yinhangkaJiluEntity);
	...
	* 获取： 银行卡记录类型的值
	*/
	public String getYinhangkaJiluValue() {
		return yinhangkaJiluValue;
	}
	/**
	* 设置： 银行卡记录类型的值
	*/
	public void setYinhangkaJiluValue(String yinhangkaJiluValue) {
		this.yinhangkaJiluValue = yinhangkaJiluValue;
	}
	...
	public String toString() {
		return "YinhangkaJiluView{" +
			", yinhangkaJiluValue=" + yinhangkaJiluValue +
