...
public class YinhangkaZhuanzhangView extends YinhangkaZhuanzhangEntity implements Serializable {
	...
	*/
	...
	public YinhangkaZhuanzhangView() {

	}

	public YinhangkaZhuanzhangView(YinhangkaZhuanzhangEntity yinhangkaZhuanzhangEntity) {
		try {
			BeanUtils.copyProperties(this, yinhangkaZhuanzhangEntity);
	...
	*/
	...
	public String toString() {
		return "YinhangkaZhuanzhangView{" +
