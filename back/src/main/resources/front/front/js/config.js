...
var centerMenu = [
    ...
    ,{
        name: '金融工具收藏',
        url: '../jinronggongjuCollection/list.html'
    }
    ,{
        name: '借款',
        url: '../jinronggongjuOrder/list.html'
    }
    ,{
        name: '理财产品收藏',
        url: '../licaichanpinCollection/list.html'
    }
    ,{
        name: '理财产品订单',
        url: '../licaichanpinOrder/list.html'
    }
    ,{
        name: '银行卡',
        url: '../yinhangka/list.html'
    }
    ,{
        name: '银行卡记录',
        url: '../yinhangkaJilu/list.html'
    }
    ,{
        name: '存款',
        url: '../yinhangkaCunkuan/list.html'
    }
    ,{
        name: '取款',
        url: '../yinhangkaQukuan/list.html'
    }
    ,{
        name: '转账',
        url: '../yinhangkaZhuanzhang/list.html'
    }
...
var indexNav = [
    {
        name: '金融工具',
        url: './pages/jinronggongju/list.html'
    },
    {
        name: '理财产品',
        url: './pages/licaichanpin/list.html'
    },
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/yinhangkehu/admin/dist/index.html#/login";
