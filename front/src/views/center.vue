  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='征信等级' prop="zhengxindengjiTypes">
                 <el-select v-model="ruleForm.zhengxindengjiTypes" disabled  placeholder='请选择征信等级'>
                     <el-option
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='工号' prop="yuangongUuidNumber">
               <el-input v-model="ruleForm.yuangongUuidNumber"disabled="true"   placeholder='工号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
...
// 注册表 员工 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.zhengxindengjiTypes)&& 'yonghu'==this.flag){
                             this.$message.error('征信等级不能为空');
                             return
                         }
