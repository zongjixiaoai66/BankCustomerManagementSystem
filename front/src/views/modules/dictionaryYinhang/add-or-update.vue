<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="银行编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="银行编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="银行编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="银行编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="银行" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="银行" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="银行" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="yinhang_types";
                        ruleForm["dicName"]="银行";
                        this.$http({
