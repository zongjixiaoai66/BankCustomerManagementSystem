    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="jinronggongjuCommentbackText">
                        <el-input type="textarea"  :readonly="ro.jinronggongjuCommentbackText" v-model="ruleForm.jinronggongjuCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jinronggongjuCommentbackText" label="评价内容" prop="jinronggongjuCommentbackText">
                            <span v-html="ruleForm.jinronggongjuCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    jinronggongjuCommentbackText: false,
                    insertTime: false,
                    replyText: false,
                    updateTime: false,
                },
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.jinronggongjuId = true;//金融工具
                this.ro.yonghuId = true;//用户
                this.ro.jinronggongjuCommentbackText = true;//评价内容
            }else{
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `jinronggongjuCommentback/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jinronggongjuCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jinronggongjuCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
