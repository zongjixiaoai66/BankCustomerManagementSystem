<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='licaichanpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="理财产品" prop="licaichanpinId">
                        <el-select v-model="ruleForm.licaichanpinId" :disabled="ro.licaichanpinId" filterable placeholder="请选择理财产品" @change="licaichanpinChange">
                            <el-option
                                    v-for="(item,index) in licaichanpinOptions"
                                    v-bind:key="item.id"
                                    :label="item.licaichanpinName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='licaichanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="理财产品名称" prop="licaichanpinName">
                        <el-input v-model="licaichanpinForm.licaichanpinName"
                                  placeholder="理财产品名称" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12" v-if="sessionTable !='licaichanpin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.licaichanpinPhoto" label="理财产品照片" prop="licaichanpinPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (licaichanpinForm.licaichanpinPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='licaichanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="投资类型" prop="licaichanpinValue">
                        <el-input v-model="licaichanpinForm.licaichanpinValue"
                                  placeholder="投资类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="licaichanpinOrderUuidNumber">
                       <el-input v-model="ruleForm.licaichanpinOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.licaichanpinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="licaichanpinOrderUuidNumber">
                           <el-input v-model="ruleForm.licaichanpinOrderUuidNumber"
                                     placeholder="订单编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="licaichanpinId" name="licaichanpinId" type="hidden">
            <input id="yonghuId" name="yonghuId" type="hidden">
            <input id="yinhangkaId" name="yinhangkaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="购买份数" prop="buyNumber">
                       <el-input v-model="ruleForm.buyNumber"
                                 placeholder="购买份数" clearable  :readonly="ro.buyNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="购买份数" prop="buyNumber">
                           <el-input v-model="ruleForm.buyNumber"
                                     placeholder="购买份数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="licaichanpinOrderTruePrice">
                       <el-input v-model="ruleForm.licaichanpinOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.licaichanpinOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="licaichanpinOrderTruePrice">
                           <el-input v-model="ruleForm.licaichanpinOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="licaichanpinOrderTypes">
                        <el-select v-model="ruleForm.licaichanpinOrderTypes" :disabled="ro.licaichanpinOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in licaichanpinOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="licaichanpinOrderValue">
                        <el-input v-model="ruleForm.licaichanpinOrderValue"
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.licaichanpinOrderYesnoTypes" label="审核状态" prop="licaichanpinOrderYesnoTypes">
                        <el-input v-model="ruleForm.licaichanpinOrderYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.licaichanpinOrderYesnoText" label="审核意见" prop="licaichanpinOrderYesnoText">
                        <span v-html="ruleForm.licaichanpinOrderYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.licaichanpinOrderShenheTime" label="审核时间" prop="licaichanpinOrderShenheTime">
                        <span v-html="ruleForm.licaichanpinOrderShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="licaichanpinOrderPaymentTypes">
                        <el-select v-model="ruleForm.licaichanpinOrderPaymentTypes" :disabled="ro.licaichanpinOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in licaichanpinOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="支付类型" prop="licaichanpinOrderPaymentValue">
                        <el-input v-model="ruleForm.licaichanpinOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    licaichanpinOrderUuidNumber: true,
                    licaichanpinId: false,
                    yonghuId: false,
                    yinhangkaId: false,
                    buyNumber: false,
                    licaichanpinOrderTruePrice: false,
                    licaichanpinOrderTypes: false,
                    licaichanpinOrderYesnoTypes: false,
                    licaichanpinOrderYesnoText: false,
                    licaichanpinOrderShenheTime: false,
                    licaichanpinOrderPaymentTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    licaichanpinOrderUuidNumber: new Date().getTime(),
                    licaichanpinId: '',
                    yonghuId: '',
                    yinhangkaId: '',
                    buyNumber: '',
                    licaichanpinOrderTruePrice: '',
                    licaichanpinOrderTypes: '',
                    licaichanpinOrderYesnoTypes: '',
                    licaichanpinOrderYesnoText: '',
                    licaichanpinOrderShenheTime: '',
                    licaichanpinOrderPaymentTypes: '',
                    insertTime: '',
                },
                licaichanpinOrderTypesOptions : [],
                licaichanpinOrderYesnoTypesOptions : [],
                licaichanpinOrderPaymentTypesOptions : [],
                licaichanpinOptions : [],
                yinhangkaOptions : [],
                yonghuOptions : [],
                rules: {
                   licaichanpinOrderUuidNumber: [
                              { required: true, message: '订单编号不能为空', trigger: 'blur' },
                          ],
                   licaichanpinId: [
                              { required: true, message: '理财产品不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=licaichanpin_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.licaichanpinOrderTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=licaichanpin_order_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.licaichanpinOrderYesnoTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=licaichanpin_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.licaichanpinOrderPaymentTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `licaichanpin/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.licaichanpinOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            licaichanpinChange(id){
                this.$http({
                    url: `licaichanpin/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.licaichanpinForm = data.data;
                    }
                });
            },
            yinhangkaChange(id){
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `licaichanpinOrder/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.licaichanpinChange(data.data.licaichanpinId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`licaichanpinOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.licaichanpinOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
