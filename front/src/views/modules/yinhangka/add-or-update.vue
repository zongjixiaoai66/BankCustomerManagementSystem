    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="征信等级" prop="zhengxindengjiValue">
                        <el-input v-model="yonghuForm.zhengxindengjiValue"
                                  placeholder="征信等级" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="征信等级" prop="zhengxindengjiValue">
                            <el-input v-model="ruleForm.zhengxindengjiValue"
                                      placeholder="征信等级" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="银行卡卡号" prop="yinhangkaUuidNumber">
                       <el-input v-model="ruleForm.yinhangkaUuidNumber"
                                 placeholder="银行卡卡号" clearable  :readonly="ro.yinhangkaUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yinhangkaPhoto" label="银行卡照片" prop="yinhangkaPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yinhangkaPhoto?$base.url+ruleForm.yinhangkaPhoto:''"
                            @change="yinhangkaPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="开卡地" prop="yinhangkaKaikadi">
                       <el-input v-model="ruleForm.yinhangkaKaikadi"
                                 placeholder="开卡地" clearable  :readonly="ro.yinhangkaKaikadi"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="银行卡类型" prop="yinhangkaTypes">
                        <el-select v-model="ruleForm.yinhangkaTypes" :disabled="ro.yinhangkaTypes" placeholder="请选择银行卡类型">
                            <el-option
                                v-for="(item,index) in yinhangkaTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="编码" prop="yinhangkaAddress">
                       <el-input v-model="ruleForm.yinhangkaAddress"
                                 placeholder="编码" clearable  :readonly="ro.yinhangkaAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="余额" prop="yinhangkaMoney">
                       <el-input v-model="ruleForm.yinhangkaMoney"
                                 placeholder="余额" clearable  :readonly="ro.yinhangkaMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yinhangkaContent"  label="卡片备注" prop="yinhangkaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yinhangkaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yinhangkaContent" label="卡片备注" prop="yinhangkaContent">
                            <span v-html="ruleForm.yinhangkaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yinhangkaUuidNumber: true,
                    yinhangkaPhoto: false,
                    yinhangkaKaikadi: false,
                    yinhangTypes: false,
                    yinhangkaTypes: false,
                    insertTime: false,
                    yinhangkaAddress: false,
                    yinhangkaMoney: false,
                    yinhangkaContent: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yinhangkaUuidNumber: new Date().getTime(),
                    yinhangkaPhoto: '',
                    yinhangkaKaikadi: '',
                    yinhangTypes: '',
                    yinhangkaTypes: '',
                ...
                rules: {
                   ...
                   yinhangkaKaikadi: [
                              { required: true, message: '开卡地不能为空', trigger: 'blur' },
                          ],
                   yinhangTypes: [
                   ...
                   insertTime: [
                              { required: true, message: '开卡日期不能为空', trigger: 'blur' },
                          ],
                   yinhangkaAddress: [
                   ...
                   yinhangkaContent: [
                              { required: true, message: '卡片备注不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yinhangka_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yinhangkaTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yinhangkaContent = _this.ruleForm.yinhangkaContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yinhangkaContent = this.ruleForm.yinhangkaContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yinhangka/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yinhangkaCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            yinhangkaPhotoUploadChange(fileUrls){
                this.ruleForm.yinhangkaPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
