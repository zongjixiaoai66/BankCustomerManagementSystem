    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yinhangkaId" name="yinhangkaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="存款编号" prop="yinhangkaCunkuanUuidNumber">
                       <el-input v-model="ruleForm.yinhangkaCunkuanUuidNumber"
                                 placeholder="存款编号" clearable  :readonly="ro.yinhangkaCunkuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="存款编号" prop="yinhangkaCunkuanUuidNumber">
                           <el-input v-model="ruleForm.yinhangkaCunkuanUuidNumber"
                                     placeholder="存款编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="存款金额" prop="yinhangkaCunkuanJine">
                       <el-input v-model="ruleForm.yinhangkaCunkuanJine"
                                 placeholder="存款金额" clearable  :readonly="ro.yinhangkaCunkuanJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="存款金额" prop="yinhangkaCunkuanJine">
                           <el-input v-model="ruleForm.yinhangkaCunkuanJine"
                                     placeholder="存款金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yinhangkaCunkuanContent"  label="存款备注" prop="yinhangkaCunkuanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yinhangkaCunkuanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yinhangkaCunkuanContent" label="存款备注" prop="yinhangkaCunkuanContent">
                            <span v-html="ruleForm.yinhangkaCunkuanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yinhangkaId: false,
                    yinhangkaCunkuanUuidNumber: true,
                    yinhangkaCunkuanJine: false,
                    yinhangkaCunkuanContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yinhangkaId: '',
                    yinhangkaCunkuanUuidNumber: new Date().getTime(),
                    yinhangkaCunkuanJine: '',
                    yinhangkaCunkuanContent: '',
                    insertTime: '',
                },
                yinhangkaOptions : [],
                rules: {
                   ...
                   yinhangkaCunkuanUuidNumber: [
                              { required: true, message: '存款编号不能为空', trigger: 'blur' },
                          ],
                   yinhangkaCunkuanJine: [
                   ...
                   yinhangkaCunkuanContent: [
                              { required: true, message: '存款备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `yinhangkaCunkuan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.yinhangkaChange(data.data.yinhangkaId)
                        _this.ruleForm.yinhangkaCunkuanContent = _this.ruleForm.yinhangkaCunkuanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yinhangkaCunkuanContent = this.ruleForm.yinhangkaCunkuanContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yinhangkaCunkuan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yinhangkaCunkuanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
