    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yinhangkaId" name="yinhangkaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="取款编号" prop="yinhangkaQukuanUuidNumber">
                       <el-input v-model="ruleForm.yinhangkaQukuanUuidNumber"
                                 placeholder="取款编号" clearable  :readonly="ro.yinhangkaQukuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="取款编号" prop="yinhangkaQukuanUuidNumber">
                           <el-input v-model="ruleForm.yinhangkaQukuanUuidNumber"
                                     placeholder="取款编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="取款金额" prop="yinhangkaQukuanJine">
                       <el-input v-model="ruleForm.yinhangkaQukuanJine"
                                 placeholder="取款金额" clearable  :readonly="ro.yinhangkaQukuanJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="取款金额" prop="yinhangkaQukuanJine">
                           <el-input v-model="ruleForm.yinhangkaQukuanJine"
                                     placeholder="取款金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yinhangkaQukuanContent"  label="取款备注" prop="yinhangkaQukuanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yinhangkaQukuanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yinhangkaQukuanContent" label="取款备注" prop="yinhangkaQukuanContent">
                            <span v-html="ruleForm.yinhangkaQukuanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yinhangkaId: false,
                    yinhangkaQukuanUuidNumber: true,
                    yinhangkaQukuanJine: false,
                    yinhangkaQukuanContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yinhangkaId: '',
                    yinhangkaQukuanUuidNumber: new Date().getTime(),
                    yinhangkaQukuanJine: '',
                    yinhangkaQukuanContent: '',
                    insertTime: '',
                },
                yinhangkaOptions : [],
                rules: {
                   ...
                   yinhangkaQukuanUuidNumber: [
                              { required: true, message: '取款编号不能为空', trigger: 'blur' },
                          ],
                   yinhangkaQukuanJine: [
                   ...
                   yinhangkaQukuanContent: [
                              { required: true, message: '取款备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '取款时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `yinhangkaQukuan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.yinhangkaChange(data.data.yinhangkaId)
                        _this.ruleForm.yinhangkaQukuanContent = _this.ruleForm.yinhangkaQukuanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yinhangkaQukuanContent = this.ruleForm.yinhangkaQukuanContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yinhangkaQukuan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yinhangkaQukuanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
