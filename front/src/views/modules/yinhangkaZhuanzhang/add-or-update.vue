    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yinhangkaId" name="yinhangkaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="转账编号" prop="yinhangkaZhuanzhangUuidNumber">
                       <el-input v-model="ruleForm.yinhangkaZhuanzhangUuidNumber"
                                 placeholder="转账编号" clearable  :readonly="ro.yinhangkaZhuanzhangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="转账编号" prop="yinhangkaZhuanzhangUuidNumber">
                           <el-input v-model="ruleForm.yinhangkaZhuanzhangUuidNumber"
                                     placeholder="转账编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="转账金额" prop="yinhangkaZhuanzhangJine">
                       <el-input v-model="ruleForm.yinhangkaZhuanzhangJine"
                                 placeholder="转账金额" clearable  :readonly="ro.yinhangkaZhuanzhangJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="转账金额" prop="yinhangkaZhuanzhangJine">
                           <el-input v-model="ruleForm.yinhangkaZhuanzhangJine"
                                     placeholder="转账金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="银行" prop="yinhangTypes">
                        <el-select v-model="ruleForm.yinhangTypes" :disabled="ro.yinhangTypes" placeholder="请选择银行">
                            <el-option
                                v-for="(item,index) in yinhangTypesOptions"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="接收卡号" prop="yinhangkaZhuanzhangJieshouKahao">
                       <el-input v-model="ruleForm.yinhangkaZhuanzhangJieshouKahao"
                                 placeholder="接收卡号" clearable  :readonly="ro.yinhangkaZhuanzhangJieshouKahao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="接收卡号" prop="yinhangkaZhuanzhangJieshouKahao">
                           <el-input v-model="ruleForm.yinhangkaZhuanzhangJieshouKahao"
                                     placeholder="接收卡号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yinhangkaZhuanzhangContent"  label="转账备注" prop="yinhangkaZhuanzhangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yinhangkaZhuanzhangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yinhangkaZhuanzhangContent" label="转账备注" prop="yinhangkaZhuanzhangContent">
                            <span v-html="ruleForm.yinhangkaZhuanzhangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yinhangkaId: false,
                    yinhangkaZhuanzhangUuidNumber: true,
                    yinhangkaZhuanzhangJine: false,
                    yinhangTypes: false,
                    yinhangkaZhuanzhangJieshouKahao: false,
                    yinhangkaZhuanzhangContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yinhangkaId: '',
                    yinhangkaZhuanzhangUuidNumber: new Date().getTime(),
                    yinhangkaZhuanzhangJine: '',
                    yinhangTypes: '',
                    yinhangkaZhuanzhangJieshouKahao: '',
                    yinhangkaZhuanzhangContent: '',
                    insertTime: '',
                },
                yinhangTypesOptions : [],
                yinhangkaOptions : [],
                rules: {
                   ...
                   yinhangkaZhuanzhangUuidNumber: [
                              { required: true, message: '转账编号不能为空', trigger: 'blur' },
                          ],
                   yinhangkaZhuanzhangJine: [
                   ...
                   yinhangkaZhuanzhangJieshouKahao: [
                              { required: true, message: '接收卡号不能为空', trigger: 'blur' },
                          ],
                   yinhangkaZhuanzhangContent: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yinhang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yinhangTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `yinhangkaZhuanzhang/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.yinhangkaChange(data.data.yinhangkaId)
                        _this.ruleForm.yinhangkaZhuanzhangContent = _this.ruleForm.yinhangkaZhuanzhangContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yinhangkaZhuanzhangContent = this.ruleForm.yinhangkaZhuanzhangContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yinhangkaZhuanzhang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yinhangkaZhuanzhangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
