        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="征信等级" prop="zhengxindengjiTypes">
                        <el-select v-model="ruleForm.zhengxindengjiTypes" :disabled="ro.zhengxindengjiTypes" placeholder="请选择征信等级">
                            <el-option
                                v-for="(item,index) in zhengxindengjiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   zhengxindengjiTypes: [
                              { required: true, message: '征信等级不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhengxindengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhengxindengjiTypesOptions = data.data.list;
                    }
                });
                this.$http({
