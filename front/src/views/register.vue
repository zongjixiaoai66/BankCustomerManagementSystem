    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">银行客户管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                       ...
                       <!--<el-form-item class="input" label="征信等级">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.zhengxindengjiTypes" placeholder="请选择征信等级">
                                <el-option
                       ...
                       <!--<el-form-item class="input" label="账户状态">
                        ...
                        <!--
                            <el-form-item label="工号" class="input" v-if="tableName=='yuangong'">
                                <el-input v-model="ruleForm.yuangongUuidNumber" autocomplete="off" placeholder="工号"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yonghu 中的 征信等级 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.zhengxindengjiTypes== null ||this.ruleForm.zhengxindengjiTypes== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yinhangkehu/img/back-img-bg.jpg);
